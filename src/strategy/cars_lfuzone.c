...
int cars_lfuzone_login(struct cache_page *page, int op)
{   
    lru_insert(page, op);
...
int cars_lfuzone_logout(struct cache_page *page, int op)
{   
    lru_remove(page, op);
...
int cars_lfuzone_hit(struct cache_page *page, int op)
{
    struct page_payload *payload = (struct page_payload *)page->priv;
...
int cars_lfuzone_writeback_privi(int type)
{
...
int cars_lfuzone_flush_allcache(){
